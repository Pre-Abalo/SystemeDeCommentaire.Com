...
try {
    ...
    if ( isset($_POST['username'], $_POST['email'], $_POST['pass'], $_POST['cpass'])){
        ...
        $reqete_mail_existe = $connection->prepare("SELECT COUNT(*) FROM admins WHERE email = :email");
        ...
        if ($email_count > 0) {?>
            ...
            if ($_POST['pass'] === $cpass){
                ...
                $sql = "INSERT INTO admins (name, email, pass, created_at)
        ...
        <div class="col-6 mt-5">
            <form action="./signUp.php" method="post">
                <fieldset class="border border-3 rounded p-5">
                    ...
                    <div>
                        <label for="username">Nom d'administrateur</label>
