...
$src = "icons/icon.png";
$icon = "icons/icon.png";
$articles ='users/view_articles.php';
$accueil = './index.php';
...
<div class="container">
    <div class="jumbotron text-center p-2">
        ...
        <a class="btn btn-primary btn-lg" href="users/view_articles.php" role="button">Publier un commentaire</a>
    </div>
    <br><br><br>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action='users/view_article.php' method='post'>
